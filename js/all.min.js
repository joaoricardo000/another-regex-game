...
a.removeClass("fade top bottom left right in"),a.find(".popover-title").html()||a.find(".popover-title").hide()},c.prototype.hasContent=function(){return this.getTitle()||this.getContent()},c.prototype.getContent=function(){var a=this.$element,b=this.options;return a.attr("data-content")||("function"==typeof b.content?b.content.call(a[0]):b.content)},c.prototype.arrow=function(){return this.$arrow=this.$arrow||this.tip().find(".arrow")};var d=a.fn.popover;a.fn.popover=b,a.fn.popover.Constructor=c,a.fn.popover.noConflict=function(){return a.fn.popover=d,this}}(jQuery),+function(a){"use strict";function b(c,d){this.$body=a(document.body),this.$scrollElement=a(a(c).is(document.body)?window:c),this.options=a.extend({},b.DEFAULTS,d),this.selector=(this.options.target||"")+" .nav li > a",this.offsets=[],this.targets=[],this.activeTarget=null,this.scrollHeight=0,this.$scrollElement.on("scroll.bs.scrollspy",a.proxy(this.process,this)),this.refresh(),this.process()}function c(c){return this.each(function(){var d=a(this),e=d.data("bs.scrollspy"),f="object"==typeof c&&c;e||d.data("bs.scrollspy",e=new b(this,f)),"string"==typeof c&&e[c]()})}b.VERSION="3.3.6",b.DEFAULTS={offset:10},b.prototype.getScrollHeight=function(){return this.$scrollElement[0].scrollHeight||Math.max(this.$body[0].scrollHeight,document.documentElement.scrollHeight)},b.prototype.refresh=function(){var b=this,c="offset",d=0;this.offsets=[],this.targets=[],this.scrollHeight=this.getScrollHeight(),a.isWindow(this.$scrollElement[0])||(c="position",d=this.$scrollElement.scrollTop()),this.$body.find(this.selector).map(function(){var b=a(this),e=b.data("target")||b.attr("href"),f=/^#./.test(e)&&a(e);return f&&f.length&&f.is(":visible")&&[[f[c]().top+d,e]]||null}).sort(function(a,b){return a[0]-b[0]}).each(function(){b.offsets.push(this[0]),b.targets.push(this[1])})},b.prototype.process=function(){var a,b=this.$scrollElement.scrollTop()+this.options.offset,c=this.getScrollHeight(),d=this.options.offset+c-this.$scrollElement.height(),e=this.offsets,f=this.targets,g=this.activeTarget;if(this.scrollHeight!=c&&this.refresh(),b>=d)return g!=(a=f[f.length-1])&&this.activate(a);if(g&&b<e[0])return this.activeTarget=null,this.clear();for(a=e.length;a--;)g!=f[a]&&b>=e[a]&&(void 0===e[a+1]||b<e[a+1])&&this.activate(f[a])},b.prototype.activate=function(b){this.activeTarget=b,this.clear();var c=this.selector+'[data-target="'+b+'"],'+this.selector+'[href="'+b+'"]',d=a(c).parents("li").addClass("active");d.parent(".dropdown-menu").length&&(d=d.closest("li.dropdown").addClass("active")),d.trigger("activate.bs.scrollspy")},b.prototype.clear=function(){a(this.selector).parentsUntil(this.options.target,".active").removeClass("active")};var d=a.fn.scrollspy;a.fn.scrollspy=c,a.fn.scrollspy.Constructor=b,a.fn.scrollspy.noConflict=function(){return a.fn.scrollspy=d,this},a(window).on("load.bs.scrollspy.data-api",function(){a('[data-spy="scroll"]').each(function(){var b=a(this);c.call(b,b.data())})})}(jQuery),+function(a){"use strict";function b(b){return this.each(function(){var d=a(this),e=d.data("bs.tab");e||d.data("bs.tab",e=new c(this)),"string"==typeof b&&e[b]()})}var c=function(b){this.element=a(b)};c.VERSION="3.3.6",c.TRANSITION_DURATION=150,c.prototype.show=function(){var b=this.element,c=b.closest("ul:not(.dropdown-menu)"),d=b.data("target");if(d||(d=b.attr("href"),d=d&&d.replace(/.*(?=#[^\s]*$)/,"")),!b.parent("li").hasClass("active")){var e=c.find(".active:last a"),f=a.Event("hide.bs.tab",{relatedTarget:b[0]}),g=a.Event("show.bs.tab",{relatedTarget:e[0]});if(e.trigger(f),b.trigger(g),!g.isDefaultPrevented()&&!f.isDefaultPrevented()){var h=a(d);this.activate(b.closest("li"),c),this.activate(h,h.parent(),function(){e.trigger({type:"hidden.bs.tab",relatedTarget:b[0]}),b.trigger({type:"shown.bs.tab",relatedTarget:e[0]})})}}},c.prototype.activate=function(b,d,e){function f(){g.removeClass("active").find("> .dropdown-menu > .active").removeClass("active").end().find('[data-toggle="tab"]').attr("aria-expanded",!1),b.addClass("active").find('[data-toggle="tab"]').attr("aria-expanded",!0),h?(b[0].offsetWidth,b.addClass("in")):b.removeClass("fade"),b.parent(".dropdown-menu").length&&b.closest("li.dropdown").addClass("active").end().find('[data-toggle="tab"]').attr("aria-expanded",!0),e&&e()}var g=d.find("> .active"),h=e&&a.support.transition&&(g.length&&g.hasClass("fade")||!!d.find("> .fade").length);g.length&&h?g.one("bsTransitionEnd",f).emulateTransitionEnd(c.TRANSITION_DURATION):f(),g.removeClass("in")};var d=a.fn.tab;a.fn.tab=b,a.fn.tab.Constructor=c,a.fn.tab.noConflict=function(){return a.fn.tab=d,this};var e=function(c){c.preventDefault(),b.call(a(this),"show")};a(document).on("click.bs.tab.data-api",'[data-toggle="tab"]',e).on("click.bs.tab.data-api",'[data-toggle="pill"]',e)}(jQuery),+function(a){"use strict";function b(b){return this.each(function(){var d=a(this),e=d.data("bs.affix"),f="object"==typeof b&&b;e||d.data("bs.affix",e=new c(this,f)),"string"==typeof b&&e[b]()})}var c=function(b,d){this.options=a.extend({},c.DEFAULTS,d),this.$target=a(this.options.target).on("scroll.bs.affix.data-api",a.proxy(this.checkPosition,this)).on("click.bs.affix.data-api",a.proxy(this.checkPositionWithEventLoop,this)),this.$element=a(b),this.affixed=null,this.unpin=null,this.pinnedOffset=null,this.checkPosition()};c.VERSION="3.3.6",c.RESET="affix affix-top affix-bottom",c.DEFAULTS={offset:0,target:window},c.prototype.getState=function(a,b,c,d){var e=this.$target.scrollTop(),f=this.$element.offset(),g=this.$target.height();if(null!=c&&"top"==this.affixed)return c>e?"top":!1;if("bottom"==this.affixed)return null!=c?e+this.unpin<=f.top?!1:"bottom":a-d>=e+g?!1:"bottom";var h=null==this.affixed,i=h?e:f.top,j=h?g:b;return null!=c&&c>=e?"top":null!=d&&i+j>=a-d?"bottom":!1},c.prototype.getPinnedOffset=function(){if(this.pinnedOffset)return this.pinnedOffset;this.$element.removeClass(c.RESET).addClass("affix");var a=this.$target.scrollTop(),b=this.$element.offset();return this.pinnedOffset=b.top-a},c.prototype.checkPositionWithEventLoop=function(){setTimeout(a.proxy(this.checkPosition,this),1)},c.prototype.checkPosition=function(){if(this.$element.is(":visible")){var b=this.$element.height(),d=this.options.offset,e=d.top,f=d.bottom,g=Math.max(a(document).height(),a(document.body).height());"object"!=typeof d&&(f=e=d),"function"==typeof e&&(e=d.top(this.$element)),"function"==typeof f&&(f=d.bottom(this.$element));var h=this.getState(g,b,e,f);if(this.affixed!=h){null!=this.unpin&&this.$element.css("top","");var i="affix"+(h?"-"+h:""),j=a.Event(i+".bs.affix");if(this.$element.trigger(j),j.isDefaultPrevented())return;this.affixed=h,this.unpin="bottom"==h?this.getPinnedOffset():null,this.$element.removeClass(c.RESET).addClass(i).trigger(i.replace("affix","affixed")+".bs.affix")}"bottom"==h&&this.$element.offset({top:g-b-f})}};var d=a.fn.affix;a.fn.affix=b,a.fn.affix.Constructor=c,a.fn.affix.noConflict=function(){return a.fn.affix=d,this},a(window).on("load",function(){a('[data-spy="affix"]').each(function(){var c=a(this),d=c.data();d.offset=d.offset||{},null!=d.offsetBottom&&(d.offset.bottom=d.offsetBottom),null!=d.offsetTop&&(d.offset.top=d.offsetTop),b.call(c,d)})})}(jQuery),function(){var t=[].slice;!function(e,i){"use strict";var n;return n=function(){function t(t,i){null==i&&(i={}),this.$element=e(t),this.options=e.extend({},e.fn.bootstrapSwitch.defaults,{state:this.$element.is(":checked"),size:this.$element.data("size"),animate:this.$element.data("animate"),disabled:this.$element.is(":disabled"),readonly:this.$element.is("[readonly]"),indeterminate:this.$element.data("indeterminate"),inverse:this.$element.data("inverse"),radioAllOff:this.$element.data("radio-all-off"),onColor:this.$element.data("on-color"),offColor:this.$element.data("off-color"),onText:this.$element.data("on-text"),offText:this.$element.data("off-text"),labelText:this.$element.data("label-text"),handleWidth:this.$element.data("handle-width"),labelWidth:this.$element.data("label-width"),baseClass:this.$element.data("base-class"),wrapperClass:this.$element.data("wrapper-class")},i),this.$wrapper=e("<div>",{"class":function(t){return function(){var e;return e=[""+t.options.baseClass].concat(t._getClasses(t.options.wrapperClass)),e.push(t.options.state?""+t.options.baseClass+"-on":""+t.options.baseClass+"-off"),null!=t.options.size&&e.push(""+t.options.baseClass+"-"+t.options.size),t.options.disabled&&e.push(""+t.options.baseClass+"-disabled"),t.options.readonly&&e.push(""+t.options.baseClass+"-readonly"),t.options.indeterminate&&e.push(""+t.options.baseClass+"-indeterminate"),t.options.inverse&&e.push(""+t.options.baseClass+"-inverse"),t.$element.attr("id")&&e.push(""+t.options.baseClass+"-id-"+t.$element.attr("id")),e.join(" ")}}(this)()}),this.$container=e("<div>",{"class":""+this.options.baseClass+"-container"}),this.$on=e("<span>",{html:this.options.onText,"class":""+this.options.baseClass+"-handle-on "+this.options.baseClass+"-"+this.options.onColor}),this.$off=e("<span>",{html:this.options.offText,"class":""+this.options.baseClass+"-handle-off "+this.options.baseClass+"-"+this.options.offColor}),this.$label=e("<span>",{html:this.options.labelText,"class":""+this.options.baseClass+"-label"}),this.$element.on("init.bootstrapSwitch",function(e){return function(){return e.options.onInit.apply(t,arguments)}}(this)),this.$element.on("switchChange.bootstrapSwitch",function(e){return function(){return e.options.onSwitchChange.apply(t,arguments)}}(this)),this.$container=this.$element.wrap(this.$container).parent(),this.$wrapper=this.$container.wrap(this.$wrapper).parent(),this.$element.before(this.options.inverse?this.$off:this.$on).before(this.$label).before(this.options.inverse?this.$on:this.$off),this.options.indeterminate&&this.$element.prop("indeterminate",!0),this._init(),this._elementHandlers(),this._handleHandlers(),this._labelHandlers(),this._formHandler(),this._externalLabelHandler(),this.$element.trigger("init.bootstrapSwitch")}return t.prototype._constructor=t,t.prototype.state=function(t,e){return"undefined"==typeof t?this.options.state:this.options.disabled||this.options.readonly?this.$element:this.options.state&&!this.options.radioAllOff&&this.$element.is(":radio")?this.$element:(this.options.indeterminate&&this.indeterminate(!1),t=!!t,this.$element.prop("checked",t).trigger("change.bootstrapSwitch",e),this.$element)},t.prototype.toggleState=function(t){return this.options.disabled||this.options.readonly?this.$element:this.options.indeterminate?(this.indeterminate(!1),this.state(!0)):this.$element.prop("checked",!this.options.state).trigger("change.bootstrapSwitch",t)},t.prototype.size=function(t){return"undefined"==typeof t?this.options.size:(null!=this.options.size&&this.$wrapper.removeClass(""+this.options.baseClass+"-"+this.options.size),t&&this.$wrapper.addClass(""+this.options.baseClass+"-"+t),this._width(),this._containerPosition(),this.options.size=t,this.$element)},t.prototype.animate=function(t){return"undefined"==typeof t?this.options.animate:(t=!!t,t===this.options.animate?this.$element:this.toggleAnimate())},t.prototype.toggleAnimate=function(){return this.options.animate=!this.options.animate,this.$wrapper.toggleClass(""+this.options.baseClass+"-animate"),this.$element},t.prototype.disabled=function(t){return"undefined"==typeof t?this.options.disabled:(t=!!t,t===this.options.disabled?this.$element:this.toggleDisabled())},t.prototype.toggleDisabled=function(){return this.options.disabled=!this.options.disabled,this.$element.prop("disabled",this.options.disabled),this.$wrapper.toggleClass(""+this.options.baseClass+"-disabled"),this.$element},t.prototype.readonly=function(t){return"undefined"==typeof t?this.options.readonly:(t=!!t,t===this.options.readonly?this.$element:this.toggleReadonly())},t.prototype.toggleReadonly=function(){return this.options.readonly=!this.options.readonly,this.$element.prop("readonly",this.options.readonly),this.$wrapper.toggleClass(""+this.options.baseClass+"-readonly"),this.$element},t.prototype.indeterminate=function(t){return"undefined"==typeof t?this.options.indeterminate:(t=!!t,t===this.options.indeterminate?this.$element:this.toggleIndeterminate())},t.prototype.toggleIndeterminate=function(){return this.options.indeterminate=!this.options.indeterminate,this.$element.prop("indeterminate",this.options.indeterminate),this.$wrapper.toggleClass(""+this.options.baseClass+"-indeterminate"),this._containerPosition(),this.$element},t.prototype.inverse=function(t){return"undefined"==typeof t?this.options.inverse:(t=!!t,t===this.options.inverse?this.$element:this.toggleInverse())},t.prototype.toggleInverse=function(){var t,e;return this.$wrapper.toggleClass(""+this.options.baseClass+"-inverse"),e=this.$on.clone(!0),t=this.$off.clone(!0),this.$on.replaceWith(t),this.$off.replaceWith(e),this.$on=t,this.$off=e,this.options.inverse=!this.options.inverse,this.$element},t.prototype.onColor=function(t){var e;return e=this.options.onColor,"undefined"==typeof t?e:(null!=e&&this.$on.removeClass(""+this.options.baseClass+"-"+e),this.$on.addClass(""+this.options.baseClass+"-"+t),this.options.onColor=t,this.$element)},t.prototype.offColor=function(t){var e;return e=this.options.offColor,"undefined"==typeof t?e:(null!=e&&this.$off.removeClass(""+this.options.baseClass+"-"+e),this.$off.addClass(""+this.options.baseClass+"-"+t),this.options.offColor=t,this.$element)},t.prototype.onText=function(t){return"undefined"==typeof t?this.options.onText:(this.$on.html(t),this._width(),this._containerPosition(),this.options.onText=t,this.$element)},t.prototype.offText=function(t){return"undefined"==typeof t?this.options.offText:(this.$off.html(t),this._width(),this._containerPosition(),this.options.offText=t,this.$element)},t.prototype.labelText=function(t){return"undefined"==typeof t?this.options.labelText:(this.$label.html(t),this._width(),this.options.labelText=t,this.$element)},t.prototype.handleWidth=function(t){return"undefined"==typeof t?this.options.handleWidth:(this.options.handleWidth=t,this._width(),this._containerPosition(),this.$element)},t.prototype.labelWidth=function(t){return"undefined"==typeof t?this.options.labelWidth:(this.options.labelWidth=t,this._width(),this._containerPosition(),this.$element)},t.prototype.baseClass=function(){return this.options.baseClass},t.prototype.wrapperClass=function(t){return"undefined"==typeof t?this.options.wrapperClass:(t||(t=e.fn.bootstrapSwitch.defaults.wrapperClass),this.$wrapper.removeClass(this._getClasses(this.options.wrapperClass).join(" ")),this.$wrapper.addClass(this._getClasses(t).join(" ")),this.options.wrapperClass=t,this.$element)},t.prototype.radioAllOff=function(t){return"undefined"==typeof t?this.options.radioAllOff:(t=!!t,t===this.options.radioAllOff?this.$element:(this.options.radioAllOff=t,this.$element))},t.prototype.onInit=function(t){return"undefined"==typeof t?this.options.onInit:(t||(t=e.fn.bootstrapSwitch.defaults.onInit),this.options.onInit=t,this.$element)},t.prototype.onSwitchChange=function(t){return"undefined"==typeof t?this.options.onSwitchChange:(t||(t=e.fn.bootstrapSwitch.defaults.onSwitchChange),this.options.onSwitchChange=t,this.$element)},t.prototype.destroy=function(){var t;return t=this.$element.closest("form"),t.length&&t.off("reset.bootstrapSwitch").removeData("bootstrap-switch"),this.$container.children().not(this.$element).remove(),this.$element.unwrap().unwrap().off(".bootstrapSwitch").removeData("bootstrap-switch"),this.$element},t.prototype._width=function(){var t,e;return t=this.$on.add(this.$off),t.add(this.$label).css("width",""),e="auto"===this.options.handleWidth?Math.max(this.$on.width(),this.$off.width()):this.options.handleWidth,t.width(e),this.$label.width(function(t){return function(i,n){return"auto"!==t.options.labelWidth?t.options.labelWidth:e>n?e:n}}(this)),this._handleWidth=this.$on.outerWidth(),this._labelWidth=this.$label.outerWidth(),this.$container.width(2*this._handleWidth+this._labelWidth),this.$wrapper.width(this._handleWidth+this._labelWidth)},t.prototype._containerPosition=function(t,e){return null==t&&(t=this.options.state),this.$container.css("margin-left",function(e){return function(){var i;return i=[0,"-"+e._handleWidth+"px"],e.options.indeterminate?"-"+e._handleWidth/2+"px":t?e.options.inverse?i[1]:i[0]:e.options.inverse?i[0]:i[1]}}(this)),e?setTimeout(function(){return e()},50):void 0},t.prototype._init=function(){var t,e;return t=function(t){return function(){return t._width(),t._containerPosition(null,function(){return t.options.animate?t.$wrapper.addClass(""+t.options.baseClass+"-animate"):void 0})}}(this),this.$wrapper.is(":visible")?t():e=i.setInterval(function(n){return function(){return n.$wrapper.is(":visible")?(t(),i.clearInterval(e)):void 0}}(this),50)},t.prototype._elementHandlers=function(){return this.$element.on({"change.bootstrapSwitch":function(t){return function(i,n){var o;return i.preventDefault(),i.stopImmediatePropagation(),o=t.$element.is(":checked"),t._containerPosition(o),o!==t.options.state?(t.options.state=o,t.$wrapper.toggleClass(""+t.options.baseClass+"-off").toggleClass(""+t.options.baseClass+"-on"),n?void 0:(t.$element.is(":radio")&&e("[name='"+t.$element.attr("name")+"']").not(t.$element).prop("checked",!1).trigger("change.bootstrapSwitch",!0),t.$element.trigger("switchChange.bootstrapSwitch",[o]))):void 0}}(this),"focus.bootstrapSwitch":function(t){return function(e){return e.preventDefault(),t.$wrapper.addClass(""+t.options.baseClass+"-focused")}}(this),"blur.bootstrapSwitch":function(t){return function(e){return e.preventDefault(),t.$wrapper.removeClass(""+t.options.baseClass+"-focused")}}(this),"keydown.bootstrapSwitch":function(t){return function(e){if(e.which&&!t.options.disabled&&!t.options.readonly)switch(e.which){case 37:return e.preventDefault(),e.stopImmediatePropagation(),t.state(!1);case 39:return e.preventDefault(),e.stopImmediatePropagation(),t.state(!0)}}}(this)})},t.prototype._handleHandlers=function(){return this.$on.on("click.bootstrapSwitch",function(t){return function(e){return e.preventDefault(),e.stopPropagation(),t.state(!1),t.$element.trigger("focus.bootstrapSwitch")}}(this)),this.$off.on("click.bootstrapSwitch",function(t){return function(e){return e.preventDefault(),e.stopPropagation(),t.state(!0),t.$element.trigger("focus.bootstrapSwitch")}}(this))},t.prototype._labelHandlers=function(){return this.$label.on({"mousedown.bootstrapSwitch touchstart.bootstrapSwitch":function(t){return function(e){return t._dragStart||t.options.disabled||t.options.readonly?void 0:(e.preventDefault(),e.stopPropagation(),t._dragStart=(e.pageX||e.originalEvent.touches[0].pageX)-parseInt(t.$container.css("margin-left"),10),t.options.animate&&t.$wrapper.removeClass(""+t.options.baseClass+"-animate"),t.$element.trigger("focus.bootstrapSwitch"))}}(this),"mousemove.bootstrapSwitch touchmove.bootstrapSwitch":function(t){return function(e){var i;return null==t._dragStart||(e.preventDefault(),i=(e.pageX||e.originalEvent.touches[0].pageX)-t._dragStart,i<-t._handleWidth||i>0)?void 0:(t._dragEnd=i,t.$container.css("margin-left",""+t._dragEnd+"px"))}}(this),"mouseup.bootstrapSwitch touchend.bootstrapSwitch":function(t){return function(e){var i;return t._dragStart?(e.preventDefault(),t.options.animate&&t.$wrapper.addClass(""+t.options.baseClass+"-animate"),t._dragEnd?(i=t._dragEnd>-(t._handleWidth/2),t._dragEnd=!1,t.state(t.options.inverse?!i:i)):t.state(!t.options.state),t._dragStart=!1):void 0}}(this),"mouseleave.bootstrapSwitch":function(t){return function(){return t.$label.trigger("mouseup.bootstrapSwitch")}}(this)})},t.prototype._externalLabelHandler=function(){var t;return t=this.$element.closest("label"),t.on("click",function(e){return function(i){return i.preventDefault(),i.stopImmediatePropagation(),i.target===t[0]?e.toggleState():void 0}}(this))},t.prototype._formHandler=function(){var t;return t=this.$element.closest("form"),t.data("bootstrap-switch")?void 0:t.on("reset.bootstrapSwitch",function(){return i.setTimeout(function(){return t.find("input").filter(function(){return e(this).data("bootstrap-switch")}).each(function(){return e(this).bootstrapSwitch("state",this.checked)})},1)}).data("bootstrap-switch",!0)},t.prototype._getClasses=function(t){var i,n,o,s;if(!e.isArray(t))return[""+this.options.baseClass+"-"+t];for(n=[],o=0,s=t.length;s>o;o++)i=t[o],n.push(""+this.options.baseClass+"-"+i);return n},t}(),e.fn.bootstrapSwitch=function(){var i,o,s;return o=arguments[0],i=2<=arguments.length?t.call(arguments,1):[],s=this,this.each(function(){var t,a;return t=e(this),a=t.data("bootstrap-switch"),a||t.data("bootstrap-switch",a=new n(this,o)),"string"==typeof o?s=a[o].apply(a,i):void 0}),s},e.fn.bootstrapSwitch.Constructor=n,e.fn.bootstrapSwitch.defaults={state:!0,size:null,animate:!0,disabled:!1,readonly:!1,indeterminate:!1,inverse:!1,radioAllOff:!1,onColor:"primary",offColor:"default",onText:"ON",offText:"OFF",labelText:"&nbsp;",handleWidth:"auto",labelWidth:"auto",baseClass:"bootstrap-switch",wrapperClass:"wrapper",onInit:function(){},onSwitchChange:function(){}}}(window.jQuery,window)}.call(this),function(i,s,o,g,r,a,m){i.GoogleAnalyticsObject=r,i[r]=i[r]||function(){(i[r].q=i[r].q||[]).push(arguments)},i[r].l=1*new Date,a=s.createElement(o),m=s.getElementsByTagName(o)[0],a.async=1,a.src=g,m.parentNode.insertBefore(a,m)}(window,document,"script","https://www.google-analytics.com/analytics.js","ga"),ga("create","UA-77325130-1","auto"),ga("send","pageview"),!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?"http":"https";d.getElementById(id)||(js=d.createElement(s),js.id=id,js.src=p+"://platform.twitter.com/widgets.js",fjs.parentNode.insertBefore(js,fjs))}(document,"script","twitter-wjs"),function(){var requirements=["ngRoute","ngSanitize","LocalStorageModule","RegexGame.controllers","RegexGame.services"];window.cordova&&requirements.push("ionic");var app=angular.module("RegexGame",requirements);app.config(["$routeProvider",function($routeProvider){$routeProvider.when("/?",{templateUrl:"/static/templates/views/index.html",controller:"IndexController"}).when("/play/:levelId",{templateUrl:"/static/templates/views/game.html",controller:"GameController"}).when("/created/?",{templateUrl:"/static/templates/views/game.html",controller:"GameController"}).when("/golf/?",{templateUrl:"/static/templates/views/game.html",controller:"GameController"}).when("/about/?",{templateUrl:"/static/templates/views/about.html",controller:"IndexController"}).when("/end/?",{templateUrl:"/static/templates/views/end.html",controller:"IndexController"}).when("/create/?",{templateUrl:"/static/templates/views/create.html",reloadOnSearch:!1,controller:"CreateController"}).when("/search/?",{templateUrl:"/static/templates/views/search.html",reloadOnSearch:!1,controller:"SearchController"}).otherwise({redirectTo:"/"})}]),window.cordova?app.run(function($ionicPlatform){$ionicPlatform.ready(function(){window.cordova&&window.cordova.plugins.Keyboard&&(cordova.plugins.Keyboard.hideKeyboardAccessoryBar(!0),cordova.plugins.Keyboard.disableScroll(!0)),window.StatusBar&&StatusBar.styleDefault()}),$("#i-know-regex-mode").bootstrapSwitch("state")}):app.run(function($rootScope,$location,$timeout){$rootScope.$on("$routeChangeSuccess",function(event){document.getElementsByTagName("body")[0].className="",ga("send","pageview",{page:$location.path()}),"undefined"!=typeof twttr&&"/"==$location.path()&&$timeout(function(){twttr.widgets.load(document.getElementById("index-container"))})}),$("#i-know-regex-mode").bootstrapSwitch("state")})}(),function(){var app=angular.module("RegexGame.controllers",[]);app.controller("IndexController",function($scope,LevelsFactory){LevelsFactory.getAll(function(err,allLevels){$scope.allLevels=allLevels})}),app.controller("CreateController",function($scope,$location,$timeout,LevelsFactory,GameStatusService){$scope.compiledRegex=null,$scope.levelData={},$scope.levelStatus=null,$scope.isSolved=!1,$scope.createdUrl="",$scope.$on("regex-update",function(event,regex){regex?($scope.compiledRegex=regex,$scope.levelData.solution=regex.source,$scope.testWords()):($scope.levelStatus=GameStatusService.getInitialStatus($scope.levelData),$scope.isSolved=!1)}),$scope.testWords=function(){$scope.checkInputWordAvailability(),$scope.compiledRegex&&($scope.levelStatus=GameStatusService.getLevelStatus($scope.levelData,$scope.compiledRegex),$scope.isSolved=100==$scope.levelStatus.percentage)},$scope.save=function(){$scope.testWords(),$scope.isSolved&&(LevelsFactory.dumpLevel($scope.levelData,function(err,levelData){$scope.createdUrl=window.location.origin+"#/created/?l="+levelData,shortener($scope.createdUrl,function(err,url){$("#created-url").val(url||$scope.createdUrl)})}),ga("send","event","create","save"))},$scope.copyToClipboard=function(){var ipt=document.getElementById("created-url");if(ipt.value.length){ipt.focus(),ipt.setSelectionRange(0,ipt.value.length);try{var copied=document.execCommand("copy");copied&&$(".alert-copy").show()}catch(e){}}},$scope.checkInputWordAvailability=function(){angular.forEach([$scope.levelData.goodWords,$scope.levelData.badWords],function(words){var total=0;angular.forEach(words,function(word){word.length>0&&total++}),total>=words.length&&words.length<20&&words.push("")})},$scope.updateRegexBuilder=function(){$timeout(function(){$scope.$broadcast("set-regex-tools",!1),$scope.$broadcast("set-regex-text",$scope.levelData.solution)})},$scope.loadLevelFromQuery=function(){LevelsFactory.loadLevel($location.search().l,function(err,levelData){$scope.levelData=levelData,$scope.testWords()})},$scope.init=function(){$location.search().l?$scope.loadLevelFromQuery():($scope.levelData={goodWords:["","","","","",""],badWords:["","","","","",""],title:"",solution:""},$scope.levelStatus=GameStatusService.getInitialStatus($scope.levelData),$scope.updateRegexBuilder())},$scope.init()}),app.controller("SearchController",function($scope,$location,$timeout,WordsFactory){$scope.wordsList=null,$scope.matches=[],$scope.search=function(regex){var matches=[];angular.forEach($scope.wordsList,function(word){var match=regex.exec(word);match&&(match[0].length?matches.push({text:match.input.replace(regex,"<span class='search-match'>"+match[0]+"</span>")}):matches.push({text:match.input}))}),matches.length>50?($scope.matches=matches.slice(0,20),$scope.matches.push({text:"..."}),$scope.matches.push({text:"..."}),$scope.matches.push({text:"..."}),$scope.matches=$scope.matches.concat(matches.slice(matches.length-20))):$scope.matches=matches,$scope.totalMatches=matches.length};var searchTimeout=null;$scope.$on("regex-update",function(event,regex){regex?($location.search("q",regex.source),$timeout.cancel(searchTimeout),searchTimeout=$timeout(function(){$scope.search(regex)},300)):($scope.matches=[],$scope.totalMatches=0,$location.search("q",null))}),$scope.updateRegexBuilder=function(){$timeout(function(){$scope.$broadcast("set-regex-tools",!1),$location.search().q&&"string"==typeof $location.search().q&&$scope.$broadcast("set-regex-text",$location.search().q)})},$scope.init=function(){WordsFactory.getDictionary({lang:"pt-br"},function(err,data){$scope.wordsList=data})},$scope.init()}),app.controller("GameController",function($scope,$timeout,$location,$routeParams,LevelsFactory,GameStatusService,localStorageService){$scope.levelData=null,$scope.gameMode="",$scope.gameStatus={},$scope.isLevelCompleted=!1,$scope.currentLevelId=0,$scope.hintsCount=0,$scope.golfSize=5,$scope.golfPoints=0,$scope.compiledRegex=null,$scope.testWords=function(){$scope.gameStatus=GameStatusService.getLevelStatus($scope.levelData,$scope.compiledRegex,!0),$scope.checkGameStatus()},$scope.checkGameStatus=function(){$scope.updateGolfPoints(),100==$scope.gameStatus.percentage&&$scope.levelData.id&&!$scope.isLevelCompleted&&$timeout(function(){$("#finish-modal").modal("show"),$scope.isLevelCompleted=!0},500)},$scope.nextLevel=function(){$(".modal").modal("hide"),$scope.currentLevelId+1>=window.levelsData.length?window.location="#/end":window.location="#/play/"+($scope.currentLevelId+1).toString(),ga("send","event","level","finished",$scope.currentLevelId||"custom")},$scope.onLevelLoaded=function(err,levelData){return err||!levelData?void(window.location="#/"):($scope.levelData=levelData,$scope.gameStatus=GameStatusService.getInitialStatus(levelData),$scope.hintsCount=0,levelData.id&&($scope.currentLevelId=parseInt($routeParams.levelId),$("body").addClass("level-"+levelData.id),$timeout(function(){$("#start-modal").modal("show")},400)),void $scope.updateRegexBuilder())},$scope.updateRegexBuilder=function(){$timeout(function(){$scope.$broadcast("set-regex-tools",$scope.levelData.startingTools||!1)})},$scope.showHint=function(){$scope.hintsCount++,$("#hints-modal").modal("show"),ga("send","event","level","hint",$scope.levelData.id)},$scope.editLevel=function(){ga("send","event","create","edit"),window.location="#/create/?l="+$location.search().l},$scope.getRandomLevel=function(){LevelsFactory.getRandomLevel({size:$scope.golfSize},$scope.onLevelLoaded),$scope.$broadcast("set-regex-text","")},$scope.solveLevel=function(){var solution=findregex($scope.levelData.goodWords,$scope.levelData.badWords);$scope.$broadcast("set-regex-text",solution)},$scope._addGolfEventListeners=function(){var $btnsGolfSize=$(".li-golfsize .btn"),golfSize=localStorageService.get("golfSize");$btnsGolfSize.removeClass("active"),$(".golf-size-"+golfSize).addClass("active"),$scope.golfSize=golfSize||5,$btnsGolfSize.click(function(e){$scope.golfSize=parseInt(e.target.innerText),localStorageService.set("golfSize",$scope.golfSize),$scope.$apply(),$scope.getRandomLevel()})},$scope.updateGolfPoints=function(){var points=0;angular.forEach($scope.gameStatus.goodWords,function(word){word.match&&(points+=10)}),angular.forEach($scope.gameStatus.badWords,function(word){word.match&&(points-=10)}),points-=$scope.compiledRegex.source.length,$scope.compiledRegex.source.indexOf("|")>=0&&(points-=4*$scope.compiledRegex.source.match(/\|/g).length),$scope.golfPoints=points},$scope.$on("regex-update",function(event,regex){regex?($scope.compiledRegex=regex,$scope.testWords()):($scope.golfPoints=0,$scope.gameStatus=GameStatusService.getInitialStatus($scope.levelData))}),$scope.init=function(){switch($location.path()){case"/created/":LevelsFactory.loadLevel($location.search().l,$scope.onLevelLoaded),$scope.gameMode="created",$("body").addClass("game-created");break;case"/golf/":$scope._addGolfEventListeners(),LevelsFactory.getRandomLevel({size:$scope.golfSize},$scope.onLevelLoaded),$scope.gameMode="golf",$("body").addClass("game-golf");break;default:LevelsFactory.get($routeParams.levelId||1,$scope.onLevelLoaded),$("body").addClass("game-level"),$scope.gameMode="level"}},$scope.init()}),app.controller("RegexBuilderController",function($scope,$timeout,localStorageService){$scope.iKnowRegexMode=!1,$scope.rawRegex="",$scope.quickTools=[".","?","+","*","[","]","^","$","|","{","}","(",")","\\","/"],$scope.regexText="",$scope.regexCompiled="",$scope.regexElements=[],$scope.inputValue="",$scope.inputQuantifier="",$scope.toolsLabel={letter:"a",dot:".",group:"[ ]",groupNegated:"[^]",anchorStart:"^",anchorEnd:"$",or:"|"},$scope.startingTools={},$scope.availableTools={},$scope.useTool=function(toolType){$scope.inputValue="",$scope.inputQuantifier="",$scope.useToolFunction[toolType](toolType)},$scope.useLetterTool=function(){_openToolModal("input-letter-modal")},$scope.useGroupTool=function(toolType){$scope.isGroupNegated="groupNegated"==toolType,_openToolModal("input-group-modal")},$scope.selectToolLetter=function(){$scope.inputValue&&($("#input-letter-modal").modal("hide"),$scope._selectTool("letter",$scope.inputValue,$scope.inputQuantifier))},$scope.selectToolGroup=function(){$scope.inputValue&&($("#input-group-modal").modal("hide"),$scope._selectTool($scope.isGroupNegated?"groupNegated":"group","["+($scope.isGroupNegated?"^":"")+$scope.inputValue+"]",$scope.inputQuantifier));
},$scope.selectSimpleTool=function(toolType){$scope._selectTool(toolType,$scope.toolsLabel[toolType],$scope.inputQuantifier)},$scope._selectTool=function(toolType,regexValue,quantifier){quantifier=quantifier||"",$scope.availableTools[toolType]--,$scope.regexText+=regexValue+quantifier,$scope.regexElements.push({type:toolType,value:regexValue,quantifier:quantifier}),$scope.updateRegex($scope.regexText)},$scope.updateRegex=function(regexText){if(regexText.length)try{$scope.regexCompiled=new RegExp(regexText)}catch(e){}else $scope.regexCompiled=null;$scope.$emit("regex-update",$scope.regexCompiled)},$scope.onRawRegexUpdate=function(){$scope.resetTools(!1),$scope.updateRegex($scope.rawRegex)},$scope.addQuickTool=function(e){$scope.rawRegex+=e,$scope.updateRegex($scope.rawRegex)},$scope.resetTools=function(emit){emit="boolean"==typeof emit?emit:!0,$scope.regexText="",$scope.regexElements=[],$scope.availableTools=angular.copy($scope.startingTools),emit&&$scope.$emit("regex-update",null)};var _addModalEventListener=function(){$("#input-letter-modal").on("show.bs.modal",function(e){setTimeout(function(){$("#input-letter").focus()},100)}),$("#input-group-modal").on("show.bs.modal",function(e){setTimeout(function(){$("#input-group").focus()},100)})},_openToolModal=function(modal_id){var $modal=$("#"+modal_id),$radiosQuantifier=$modal.find("input:radio");$radiosQuantifier.attr("checked",!1),$($radiosQuantifier[0]).attr("checked",!0);var $btnsQuantifier=$modal.find(".btn-quantifier");$btnsQuantifier.removeClass("active"),$($btnsQuantifier[0]).addClass("active"),$modal.modal("show")};$scope.inputFilters={letter:function(){$scope.inputValue=$scope.inputValue.toLowerCase().replace(/[^a-z]+/g,"").substr($scope.inputValue.length-1)},group:function(){$scope.inputValue=$scope.inputValue.toLowerCase().replace(/[^a-z]+/g,"").substr(0,5)}},$scope.useToolFunction={letter:$scope.useLetterTool,dot:$scope.selectSimpleTool,group:$scope.useGroupTool,groupNegated:$scope.useGroupTool,anchorStart:$scope.selectSimpleTool,anchorEnd:$scope.selectSimpleTool,or:$scope.selectSimpleTool},$scope.$on("set-regex-tools",function(event,tools){$scope.startingTools=tools||!1,_addModalEventListener(),$scope.resetTools()}),$scope.$on("set-regex-text",function(event,regexText){$scope.rawRegex=regexText,$scope.updateRegex($scope.rawRegex)}),$scope.init=function(){$scope.iKnowRegexMode=localStorageService.get("iKnowRegexMode");var $i=$("#i-know-regex-mode");$i.bootstrapSwitch("state",$scope.iKnowRegexMode),$i.on("switchChange.bootstrapSwitch",function(event,state){localStorageService.set("iKnowRegexMode",state),$scope.iKnowRegexMode=state,$scope.$apply()})},$scope.init()})}(),window.levelsData=[{goodWords:["aaaaaaaaa","abc","aaces","abacate","amora","aspargos"],badWords:["sgfgkllgd","sdhdlfk","pwutf","mflsir","jkf","fpfkd"],startingTools:{letter:9,dot:9,group:9,groupNegated:9,anchorStart:9,anchorEnd:9,or:9},solution:"a",labels:{title:"The Test Level"},modals:{start:{title:"Title Start",subtitle:"subtitle text",text:"text"},finish:{title:"Wow!",subtitle:"subtitle"},hints:[]},id:"0"},{goodWords:["abc","amora","macaco","abacate","coisa","aspargos","taxi"],startingTools:{letter:1},solution:"a",labels:{title:"The Letter"},modals:{start:{title:"Another Regex Game",subtitle:"a game about patterns",text:"Find out what is unique in all these words and use the available tools on the bottom to create a pattern."},finish:{title:"Nice!",subtitle:"master of the letters",text:"It will get harder..."},hints:[{title:"Only one letter",subtitle:"",text:"Look better at the words"},{title:"just A letter",subtitle:"",text:"One letter that is in every word"}]},id:"1"},{goodWords:["oito","coisa","android","biscoito","doido","afoito","adenoide"],badWords:["lapis","macaco","reddit","amora","zelda","ocarina","ostentar"],startingTools:{letter:2},solution:"oi",labels:{title:"Avoid the bad"},modals:{start:{title:"Left good, right bad",subtitle:"match only the first column",text:"Figure out what is unique in the good words"},finish:{title:"Good one",subtitle:"",text:"Not difficult yet.."},hints:[{title:"Two letter pattern",subtitle:"",text:"Not one, but two letter in sequence!"}]},id:"2"},{goodWords:["teste","coisarada","cabana","banana","laptop","escova"],badWords:["ab","bc","xs","md","lg","af"],startingTools:{dot:9},solution:"...",labels:{title:"The Anything"},modals:{start:{title:"Introducing the dot",subtitle:". matches any letter",text:"Use the dot to match only the first column"},finish:{title:"Great",subtitle:"",text:".... job!"},hints:[{title:"Only two letters in the right",subtitle:"",text:"Create a pattern to match only three letters or more!"}]},id:"3"},{goodWords:["aboboreira","vovozinha","manolo","aeroporto","jocoso","benevolo"],badWords:["xarope","livro","amendoa","biscoito","rainha","fonte"],startingTools:{letter:2,dot:1},solution:"o.o",labels:{title:"A real pattern"},modals:{start:{title:"The first pattern",subtitle:"combine your tools",text:"Look for a unique pattern in all words on the first column"},finish:{title:"Well done!",subtitle:"",text:"harder yet?"},hints:[{title:"Three letters pattern",subtitle:"⚆.⚆",text:"You have to use all tools to solve this level"},{title:"A letter, anything, another letter",subtitle:"",text:"Look for this pattern"},{title:"X.X",subtitle:"",text:""}]},id:"4"},{goodWords:["sabado","sentir","bolacha","estupido","salgueiro","biscoito"],badWords:["enfurnar","grampo","vivencial","gotejar","tony","lalau"],startingTools:{group:1},solution:"[sb]",labels:{title:"The group"},modals:{start:{title:"Introducing the group [ ]",subtitle:"it can be a set of letters",text:"[abc] can be, guess what, a or b or c!"},finish:{title:"Cool",subtitle:"",text:"Calm down, still introducing tools..."},hints:[{title:"Find unique letters",subtitle:"",text:"There are two letters on the good words that are not on the bad words"},{title:"Keep Looking",subtitle:"",text:"One letter is 's'"}]},id:"5"},{goodWords:["jurisdicao","rebarba","radio","javanes","ressabiado","random"],badWords:["minicamera","alfazema","bangladesh","gotejar","tony","advirtamos"],startingTools:{dot:1,group:1,anchorStart:1},solution:"^[jr]",labels:{title:"The beginning"},modals:{start:{title:"Introducing the beginning ^",subtitle:"mark the beginning of the word",text:"while 'a' will match any word with an 'a' in any position, '^a' will match only the words that starts with 'a'"},finish:{title:"Suberb!",subtitle:"",text:"running out of encouragement words..."},hints:[{title:"The Anchor Start",subtitle:"^",texts:["^a","O - aba ase axx a aaa","X - ba se xx d tea"]},{title:"The good words starts with...",subtitle:"check it out!",text:"If it starts with more than one letter (AND IT DOES), you can use the group"}]},id:"6"},{goodWords:["caramelado","encefaloide","notabilidade","bagda","tigelada","racudo"],badWords:["taboao","veterano","ritmo","enfrentar","amandita","texas"],startingTools:{dot:1,letter:1,anchorEnd:1},solution:"d.$",labels:{title:"The end."},modals:{start:{title:"Introducing the end $",subtitle:"mark the end of the word",text:"While 'a' will match any word with an 'a' in any position, 'a$' will match only the words that ends with 'a'"},finish:{title:"You are a good person",subtitle:"",text:"...right?"},hints:[{title:"The Anchor End",subtitle:"$",texts:["no$","O - cano veneno abono","X - alo bingo test got"]},{title:"Look for a pattern in the end",subtitle:"maybe it's not the last letter",text:"But, probably, it's really close to the end"}]},id:"7"},{goodWords:["icq","ceo","dai","joe","mpb","fps"],badWords:["inovativo","meta","et","jacare","iriam","telejornal"],startingTools:{letter:2,dot:8,anchorStart:1,anchorEnd:1},solution:"^...$",labels:{title:"Quick recap I"},modals:{start:{title:"Exactly three letters",subtitle:"how to match only words with three letters",texts:["Do not forget that",". is any letter","[ ] is a group","^ is the beginning","$ is the end"]},finish:{title:"Great!",subtitle:"",text:"it's not getting any easier"},hints:[{title:"You already know",subtitle:"",text:"Between the start and the end of the words, there is any three letters"}]},id:"8"},{goodWords:["flagelo","niagara","flagelo","nuance","fraude","nba"],badWords:["abacaxi","fabular","xangai","nutricional","iriam","abstinha"],startingTools:{dot:1,group:1,letter:1,anchorEnd:1,anchorStart:1},solution:"^[nf].a",labels:{title:"Quick recap II"},modals:{start:{title:"Let's review",subtitle:"Combine the tools you already used",texts:["Do not forget that",". is any letter","[ ] is a group","^ is the beginning","$ is the end"]},finish:{title:"SHARE THIS WITH TWO FRIENDS TO UNLOCK THE NEXT LEVEL",subtitle:"",text:"do not click on the button before doing this, please."},hints:[{title:"Do not expect many hints...",subtitle:"",text:""},{title:"Keep thinking!",subtitle:"one thing you will use is [nf]",text:""},{title:"Take your time",subtitle:"another is 'a'",text:"And that is it, no more hints."},{title:":)",subtitle:"",text:""}]},id:"9"},{goodWords:["solarizar","guache","conterei","descabia","fervedura","puderem","colegial"],badWords:["azular","botocudo","blogagem","assadura","autopsiar","boricado","artropode"],startingTools:{dot:3,groupNegated:1,anchorStart:1,anchorEnd:1},solution:"^[^ab]",labels:{title:"The negated group"},modals:{start:{title:"Introducing the negated group [^]",subtitle:"When it's easier to say what something is not",texts:["The negated group works just like the group, except it's the opposite","'[^abc]' -> g x d gth kkkkk","[^abc] will match [def...] got it, right?"]},finish:{title:"( ͡ᵔ ͜ʖ ͡ᵔ )",subtitle:"good",text:""},hints:[{title:"Find what is unique on the bad words",subtitle:"",text:"And negate it!"}]},id:"10"},{goodWords:["agenda","fachada","mandioca","palhoca","guasca","descida"],badWords:["pacotaco","facanha","visagismo","palido","paisana","gomo"],startingTools:{letter:3,dot:1,group:1,anchorStart:1,anchorEnd:1},solution:"[cd]a$",labels:{title:"Quick recap III"},modals:{start:{title:"Let's review",subtitle:"play around with the tools you got",texts:["Do not forget that",". is any letter","[ ] is a group","^ is the beginning","$ is the end"]},finish:{title:"\\o/",subtitle:"yay",text:"getting harder..."},hints:[{title:"It's getting harder",subtitle:"a"},{title:"Keep thinking!",subtitle:"one thing you will use is [cd]"}]},id:"11"},{goodWords:["pipi","true","moais","oreo","reto","ribas"],badWords:["serio","aco","tenor","jacare","iriam","pluvial"],startingTools:{dot:4,letter:2,group:1,anchorStart:1,anchorEnd:1},solution:"^....s?$",labels:{title:"Got quantifier?"},modals:{start:{title:"Introducing quantifiers",subtitle:"? means that it can be there or not",texts:["a? means 0 or 1 'a'.","'a?b' -> 'b' 'ab'"]},finish:{title:"⊙▂⊙",subtitle:"nice!",text:""},hints:[{title:"It have four letters",subtitle:"",text:"but sometimes, there is one more..."}]},id:"12"},{goodWords:["abbbbc","abbbbccc","abc","abb","bbccc","bb"],badWords:["banana","cabbaad","abada","aabbc","aaccbbdd","accdd"],startingTools:{letter:3,anchorStart:1,anchorEnd:1},solution:"^...$",labels:{title:"The quantifiers"},modals:{start:{title:"Introducing quantifiers",subtitle:"+ and * means that it can repeat",texts:["a+ means 1 to many","'a+b' - ab aab aaaab","a* means 0 to many","'a*b' - b ab aab aaaab"]},finish:{title:"Got it?",subtitle:"",text:"if not, feel free to replay some levels"},hints:[{title:"The ? means maybe",subtitle:"It can or can't be there"},{title:"The +",subtitle:"There is at least one, but can be a lot"},{title:"The *",subtitle:"Can be any amount at all, zero to many"},{title:"Check the good words",subtitle:"It always starts with a single 'a'. Or does it?"},{title:"But there is at least one 'b'",subtitle:""}]},id:"13"},{goodWords:["haveis","sulcar","hoover","herege","legalizar","horacio","adamastor"],badWords:["tramela","macarrao","carlton","retinto","paranaue","meganha","cuica"],startingTools:{letter:2,anchorStart:1,anchorEnd:1,or:1},solution:"^h|r$",labels:{title:"The or "},modals:{start:{title:"Introducing the or |",subtitle:"when one pattern is not enough",texts:["The '|' allows you to create more than one pattern.","If does not match the first, keeps testing the others patterns separated by the '|'","'a | bc' -> asx gra tbce bc a","'a$ | bc?' -> sxa gra tbce bc bx a"]},finish:{title:"¯\\_(ツ)_/¯",subtitle:"That's it.",text:""},hints:[{title:"You have two simple patterns",subtitle:"",text:"check your tools and find the two different patterns on the good words"},{title:"Words starts with h OR ends with r",subtitle:"",text:"Just create this pattern!"}]},id:"14"},{goodWords:["servo","produtor","folheiro","gringo","supino","puderem","negrito"],badWords:["vacilar","hebraize","sumamos","angariar","highlander","abu","armadura"],startingTools:{groupNegated:1,anchorStart:1,anchorEnd:1},solution:"^[^abc]$",labels:{title:"The negated group II"},modals:{start:{title:"Everything but [^abc]",subtitle:"When it's easier says what something is not",texts:["'[^abc]' -> g x d gth kkkkk","[^abc] will match [def...] got it, right?"]},finish:{title:"(ง°ل͜°)ง",subtitle:"hooray!",text:""},hints:[{title:"The pattern is on the bad words",subtitle:"",text:"You have to match everything, but the unique letters on the bad words"},{title:"Find the two unique letters in bad words",subtitle:"",text:"And make sure that the words starts and ends without it!"}]},id:"15"},{goodWords:["alemanha","acaraje","penadinho","empunhadura","bandeja","acanhar","marinheiro","molejo","peleja"],badWords:["alocativo","rodizio","satiricamente","ursao","fiasco","xaxim","yamaha","itajuba","depender"],startingTools:{letter:3,dot:2,groupNegated:1,anchorEnd:1,or:2},solution:"nh|j.$",labels:{title:"Level I"},modals:{start:{title:"No more tutorials",subtitle:"at least for some time",texts:["I hope you got all tools so far.","It's all you have now"]},finish:{title:"Bored?",subtitle:"",text:"press '000' (if on computer...)"},hints:[{title:"Two patterns for all good words!",subtitle:"",text:"look for simple solutions first"},{title:"One pattern is only two letters",subtitle:"",text:""},{title:"The other is by the end",subtitle:"",text:""}]},id:"16"},{goodWords:["flamejar","diadema","flame","fraternal","frame","flagelar","diazepam","fiavel","dialetico"],badWords:["filmete","provem","baixela","silveira","fiadura","chopeiro","adware","rodoanel","diabolico"],startingTools:{letter:3,dot:4,group:1,groupNegated:1,anchorStart:1,anchorEnd:1,or:1},solution:"^[fd].a.e",labels:{title:"Level II"},modals:{start:{title:"No more tutorials",subtitle:"may the force be with you",texts:["... always!"]},finish:{title:"You can create levels",subtitle:"#regexgame",text:"And share it's url for others to play.."},hints:[]},id:"17"},{goodWords:["sorriamos","sacudais","sustinhamos","satanas","sdds","sigas","sortimos","salsa"],badWords:["lampada","seres","baixela","soutiens","macaco","saberieis","perfume","salada"],startingTools:{letter:3,dot:2,group:1,groupNegated:1,anchorStart:1,anchorEnd:1,or:1},solution:"^[^be]+s",labels:{title:"Hungry for regex?"},modals:{start:{title:"What's my purpose?",subtitle:"",text:"you solve regex."},finish:{title:"Check our github project!",subtitle:"not now, but sometime...",text:""},hints:[]},id:"18"},{goodWords:["guardar","amante","entuchar","notabilidade","gospels","concha","licitude","barbicha"],badWords:["simetria","relevar","retaliativo","cobri","bretanha","retangular","xongas","realengo"],startingTools:{letter:6,dot:3,group:2,groupNegated:2,anchorStart:1,anchorEnd:1,or:2},solution:"^g|e$|cha",labels:{title:"A long one"},modals:{start:{title:"Nothing new",subtitle:"just a lot o old stuff",texts:[]},finish:{title:"...",subtitle:"(._.) ( l: ) ( .-. ) ( :l ) (._.)",text:""},hints:[{title:"Many solutions for this, keep trying"}]},id:"19"},{goodWords:["sorti","roeu","reserva","hospital","errata","herbicida","oficina","sorri","heresia","opala"],badWords:["sacrilego","depreciativo","intrigar","drogar","parmesao","abstinhas","bob","realengo","antedais","desferrar"],startingTools:{letter:4,group:3,dot:3,groupNegated:1,anchorStart:2,anchorEnd:2,or:2},solution:"^[horse]+[^horse]+$",labels:{title:"Horse"},modals:{start:{title:"Good Luck",subtitle:"There is more than one way to solve this",texts:[]},finish:{title:"ಠ‿↼",subtitle:"super",text:""},hints:[{title:"There is a simple way",subtitle:"Hard to spot",text:"(the same group used twice)"}]},id:"20"}],function(global,isTest){function getMatches(wordList,regex){for(var matches=[],i=0;i<wordList.length;i++)regex.exec(wordList[i])&&matches.push(wordList[i]);return matches}function subparts(word,n){n=n||subPartsMaxSize;for(var fullWord="^"+word+"$",parts={},step=0;step++<n;)for(var i=0;i<fullWord.length;i++)parts[fullWord.substr(i,step)]=0;return parts}function dotify(wordPart,prefix){var fn=function(wordPart,prefix){if(0!=wordPart.length){prefix=prefix||"";for(var part=wordPart.slice(),dotified={},i=0;i<part.length;i++)for(var j=1;j<part.length-i+1;j++){var p=part.substr(i,j).replace(/[^\^\$\.]/g,"."),partial=[part.substr(0,i),p,part.substr(i+j)].join("");dotified[prefix+partial]=0}return _extend(dotified,fn(wordPart.slice(1),prefix+("^"==wordPart[0]?"^":"."))),_extend(dotified,fn(wordPart.slice(1),prefix+wordPart[0])),dotified}};return fn(wordPart,prefix)}function getFullWordsRegex(wordList){for(var parts=[],i=0;i<wordList.length;i++)parts.push("^"+wordList[i]+"$");return parts}function getScoredPool(regexPool,goodWords,badWords){for(var regexPoolByScore={},i=0;i<regexPool.length;i++){var regexPart=regexPool[i],regexp=new RegExp(regexPart);if(!badWords||!getMatches(badWords,regexp).length){var goodMatches=getMatches(goodWords,regexp);if(goodMatches.length){var score=goodMatches.length*scoreMatch-regexp.source.length;try{regexPoolByScore[score].push(regexp)}catch(e){regexPoolByScore[score]=[regexp]}}}}for(var scores=Object.keys(regexPoolByScore).sort(sortScores),regexListByScore=[];scores.length;)for(score=scores.pop();regexPoolByScore[score].length;)regexListByScore.push(regexPoolByScore[score].pop());return regexListByScore}function getRegexParts(goodWords){for(var regexPartsPool={},i=0;i<goodWords.length;i++)_extend(regexPartsPool,subparts(goodWords[i]));var dotifieds={};for(var p in regexPartsPool)_extend(dotifieds,dotify(p));_extend(regexPartsPool,dotifieds);var regexPartsList=Object.keys(regexPartsPool);return regexPartsList=regexPartsList.concat(getFullWordsRegex(goodWords))}function findRegex(goodWords,badWords){for(var allRegexParts=getRegexParts(goodWords),regexPool=getScoredPool(allRegexParts,goodWords,badWords),winnersLeft=goodWords.slice(),regexParts=[];winnersLeft.length;){for(var newMatches=[],regexPart=regexPool.pop(),i=0;i<winnersLeft.length;i++)regexPart.exec(winnersLeft[i])&&newMatches.push(winnersLeft[i]);if(newMatches){regexParts.push(regexPart.source);for(var i=0;i<newMatches.length;i++)winnersLeft.splice(winnersLeft.indexOf(newMatches[i]),1);regexPool=getScoredPool(regexPool,winnersLeft)}}return regexParts.join("|")}var scoreMatch=4,subPartsMaxSize=4,_extend=function(objA,objB){for(var k in objB)objA[k]=objB[k]},sortScores=function(a,b){return b-a};isTest&&(global.subparts=subparts,global.dotify=dotify,global.getMatches=getMatches,global.getScoredPool=getScoredPool,global.getRegexParts=getRegexParts),global.findregex=findRegex}("undefined"==typeof window?global:window,"undefined"==typeof window),function(){var app=angular.module("RegexGame.services",[]);app.factory("LevelsFactory",function(GameStatusService,WordsFactory){function isLevelDataValid(loadedLevelData){var levelRegex=new RegExp(loadedLevelData.solution);if(0==loadedLevelData.goodWords.length||loadedLevelData.goodWords.length>25||loadedLevelData.badWords.length>25)throw"Invalid Level Words";var checkSize=function(word){if(word.length>30)throw"Invalid Level Words Size"};angular.forEach(loadedLevelData.goodWords,checkSize),angular.forEach(loadedLevelData.badWords,checkSize);var gameStatus=GameStatusService.getLevelStatus(loadedLevelData,levelRegex);return 100==gameStatus.percentage}var Levels={};return Levels.get=function(id,next){next(null,window.levelsData[id])},Levels.getAll=function(next){next(null,window.levelsData)},Levels.getRandomLevel=function(args,next){var size=args.size||5;WordsFactory.getDictionary({lang:args.lang},function(err,words){for(var all={},totalWords=words.length,levelData={labels:{title:"Golf"},goodWords:[],badWords:[]},w="";levelData.goodWords.length<size;)w=words[parseInt(Math.random()*totalWords)],!all[w]&&w.length<14&&(levelData.goodWords.push(w),all[w]=!0);for(;levelData.badWords.length<size;)w=words[parseInt(Math.random()*totalWords)],!all[w]&&w.length<14&&(levelData.badWords.push(w),all[w]=!0);next(null,levelData)})},Levels.dumpLevel=function(args,next){var title=args.title||"A Title",solution=args.solution,goodWords=args.goodWords,badWords=args.badWords,clearGoodWords=[];angular.forEach(goodWords,function(word){word.length>0&&clearGoodWords.push(word)});var clearBadWords=[];angular.forEach(badWords,function(word){word.length>0&&clearBadWords.push(word)});var textJson=JSON.stringify({labels:{title:title},solution:solution,goodWords:clearGoodWords,badWords:clearBadWords});next(null,encodeURIComponent(Crypto.util.bytesToBase64(Crypto.charenc.UTF8.stringToBytes(textJson))))},Levels.loadLevel=function(encodedLevelData,next){try{var loadedLevelData=JSON.parse(Crypto.charenc.UTF8.bytesToString(Crypto.util.base64ToBytes(decodeURIComponent(encodedLevelData))));isLevelDataValid(loadedLevelData)?next(null,loadedLevelData):next("Invalid Level Data",null)}catch(e){next(e,null)}},Levels}),app.factory("WordsFactory",function($http){var Words={},db_url=window.staticBaseUrl+"js/db/",cache={};return Words.getDictionary=function(args,next){var lang=args.lang||"pt-br";cache[lang]?next(null,cache[lang]):$http.get(db_url+lang).then(function(response){cache[lang]=response.data.split("\n"),next(null,cache[lang])})},Words}),app.service("GameStatusService",function(){function _buildSpanMatch(match){return[escapeHtml(match.input.substr(0,match.index)),"<span class='regex-match'>"+escapeHtml(match[0])+"</span>",escapeHtml(match.input.substr(match.index+match[0].length))].join("")}function _getWordListStatus(words,regex,spanMatch){for(var wordsStatus=[],validWordCount=0,matchCount=0,i=0;i<words.length;i++){var word=words[i];if(word.length){validWordCount++;var match=regex.exec(word);if(match){matchCount++,wordsStatus[i]={text:spanMatch?_buildSpanMatch(match):escapeHtml(word),match:match};continue}}wordsStatus[i]={text:escapeHtml(word),match:!1}}return{words:wordsStatus,percentage:parseInt(100*matchCount/validWordCount)}}var GameStatus={};return GameStatus.getInitialStatus=function(levelData){for(var levelStatus={goodWords:[],badWords:[],percentage:0},i=0;i<levelData.goodWords.length;i++)levelStatus.goodWords.push({text:escapeHtml(levelData.goodWords[i]||""),match:!1});if(levelData.badWords)for(i=0;i<levelData.badWords.length;i++)levelStatus.badWords.push({text:escapeHtml(levelData.badWords[i]||""),match:!1});return levelStatus},GameStatus.getLevelStatus=function(levelData,regex,spanMatch){var statusGood=_getWordListStatus(levelData.goodWords,regex,spanMatch),statusBad=levelData.badWords?_getWordListStatus(levelData.badWords,regex,spanMatch):null;return{goodWords:statusGood.words,badWords:statusBad?statusBad.words:[],percentage:statusBad&&statusBad.percentage?0:statusGood.percentage}},GameStatus})}();var entityMap={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;","/":"&#x2F;"};angular.module("RegexGame").run(["$templateCache",function($templateCache){$templateCache.put("/static/templates/views/about.html",'\n<div class="container about col-md-6 col-md-offset-3">\n  <h1 class="text-center">Another Regex Game</h1>\n  <p>Heavly inspired by the many great regex games that already existed, like</p>\n  <p><a href="http://regex.alf.nu" target="_blank">Regex Golf</a>&nbspand&nbsp<a href="https://regexcrossword.com/" target="_blank">Regex Crosswords</a></p>\n  <h2>What is it?</h2>\n  <p>A game about finding patterns and creating expressions for words validation.</p>\n  <h2>What?</h2>\n  <p>You create regular expressions to analyze words letter by letter, and validates it based on rules.</p>\n  <h2>...?</h2>\n  <p>You teach your computer to analyse words! So much fun!</p>\n  <h2>How can I learn more about regular expressions?</h2>\n  <p>The internet is full of content for all skill level, just look for it. A good place to start<a href="https://en.wikipedia.org/wiki/Regular_expression" target="_blank"> is the wikipedia article.</a></p>\n  <h2>How can I save and share a level?</h2>\n  <p>You can\'t really save, just share the url.</p>\n  <p>It\'s a good idea to share using #regexgame, so for the first time you will use a hashtag to store and index similar content for a quick search.</p>\n  <h2>What are those strange words?</h2>\n  <p>Those words are in portuguese.</p>\n  <h2>I want to build my own regex game, with spanish words and hookers.</h2>\n  <p>Great! All the source code is available on github, and it\'s quite easy to create your own levels and add your words.</p>\n  <p>Please let me know if you do! (I would love to play some levels that I did not created)</p>\n  <p><a href="http://github.com/joaoricardo000/another-regex-game" target="_blank">Github Project</a></p>\n  <h2>I found a problem or I have a really good opinion.</h2>\n  <p>Please let us know! Use our issue tracker on github:</p>\n  <p><a href="https://github.com/joaoricardo000/another-regex-game/issues" target="_blank">Check our issues list!</a></p>\n  <h2>How the points on golf are calculated?</h2>\n  <p>Every good match +10 points, bad match -10.</p>\n  <p>For every character in regex -1 point and -5 for each | .</p>\n  <h2>How the regex solver in the golf mode works?</h2>\n  <p>For a very good and complete explanation of the method, check&nbsp<a href="http://nbviewer.jupyter.org/url/norvig.com/ipython/xkcd1313.ipynb" target="_blank">Peter Norvig - xkcd 1313: Regex Golf</a></p>\n</div><a href="http://github.com/joaoricardo000/another-regex-game" target="_blank" title="Fork me on GitHub" class="github-fork-ribbon left-bottom fixed">Fork me on GitHub</a>'),$templateCache.put("/static/templates/views/create.html",'\n<div class="container index ng-cloak">\n  <div id="create-container" class="col-md-6 col-md-offset-3">\n    <div class="title col-xs-12">\n      <h1 class="col-xs-12">Create</h1>\n    </div>\n    <input type="text" placeholder="..title" ng-model="levelData.title" class="col-xs-12 input-title input-lg"/>\n    <div class="row">\n      <div class="words-list col-xs-6">\n        <ul class="list-good-words list-group">\n          <li ng-repeat="word in levelData.goodWords track by $index" ng-class="{\'list-group-item-success\':levelStatus.goodWords[$index].match}" class="list-group-item">\n            <input type="text" ng-model="levelData.goodWords[$index]" ng-change="testWords()" class="input-word"/>\n          </li>\n        </ul>\n      </div>\n      <div class="words-list col-xs-6">\n        <ul class="list-bad-words list-group">\n          <li ng-repeat="word in levelData.badWords track by $index" ng-class="{\'list-group-item-danger\':levelStatus.badWords[$index].match}" class="list-group-item">\n            <input type="text" ng-model="levelData.badWords[$index]" ng-change="testWords()" maxlength="30" class="input-word"/>\n          </li>\n        </ul>\n      </div>\n    </div>\n    <div ng-include="\'/static/templates/views/regex-builder.html\'" onload="updateRegexBuilder()" class="regex-builder"></div>\n    <div ng-show="isSolved" class="col-xs-12">\n      <div class="input-group created-group"><span class="input-group-btn">\n          <button id="btn-save" ng-click="save()" class="btn btn-success">Save</button></span>\n        <input id="created-url" readonly="readonly" type="text" ng-click="copyToClipboard()" class="form-control"/>\n      </div>\n      <div role="alert" style="display:none" class="alert-copy alert alert-dismissible alert-info fade in out text-center"><strong>Copied! &nbsp;&nbsp;</strong><span>Go to level&nbsp;<a ng-href="{{ createdUrl }}" class="alert-link">clicking here</a></span>\n        <button type="button" onclick="$(\'.alert-copy\').hide()" aria-label="Close" class="close"><span aria-hidden="true">&times;</span></button>\n      </div>\n    </div>\n  </div>\n</div>'),$templateCache.put("/static/templates/views/end.html",'\n<div class="container nomorelevels col-md-6 col-md-offset-3">\n  <h1 class="text-center">Another Regex Game</h1><i class="fa fa-trophy end-trophy"></i>\n  <h2 class="text-center">Congratulations!</h2>\n  <h3 class="text-center">You won a trophy!</h3>\n</div><a href="http://github.com/joaoricardo000/another-regex-game" target="_blank" title="Fork me on GitHub" class="github-fork-ribbon left-bottom fixed">Fork me on GitHub</a>'),$templateCache.put("/static/templates/views/game.html",'\n<div class="container index ng-cloak">\n  <div id="game-container" ng-show="levelData" class="col-md-6 col-md-offset-3">\n    <div class="col-xs-12 title"><i ng-click="showHint()" ng-show="gameMode == \'level\'" class="fa fa-lightbulb-o icon-button hint-button"></i><i ng-click="solveLevel()" ng-show="gameMode == \'golf\' || gameMode == \'created\'" class="fa fa-bolt icon-button solve-button"></i><i ng-click="editLevel()" ng-show="gameMode == \'created\'" class="fa fa-pencil icon-button edit-button"></i><i ng-click="getRandomLevel()" ng-show="gameMode == \'golf\'" class="fa fa-forward icon-button random-button"></i>\n      <h1>{{ levelData.labels.title }}</h1>\n      <h3 class="title percentage">{{gameMode == \'level\'?gameStatus.percentage+\'%\':golfPoints+\' points\'}}</h3>\n    </div>\n    <div class="row">\n      <div ng-class="{\'col-xs-6\':gameStatus.badWords.length, \'col-xs-12\':gameStatus.badWords.length == 0}" class="words-list">\n        <ul class="list-group list-good-words">\n          <li ng-repeat="goodWord in gameStatus.goodWords track by $index" ng-bind-html="goodWord.text" ng-class="{\'list-group-item-success\':goodWord.match}" class="list-group-item"></li>\n        </ul>\n      </div>\n      <div class="col-xs-6 words-list">\n        <ul ng-show="gameStatus.badWords.length" class="list-group list-bad-words">\n          <li ng-repeat="badWord in gameStatus.badWords track by $index" ng-bind-html="badWord.text" ng-class="{\'list-group-item-danger\':badWord.match}" class="list-group-item"></li>\n        </ul>\n      </div>\n    </div>\n    <div ng-include="\'/static/templates/views/regex-builder.html\'" onload="updateRegexBuilder()" class="regex-builder"></div>\n    <div ng-show="isLevelCompleted" class="col-xs-12 text-center">\n      <button ng-click="nextLevel()" class="btn btn-lg btn-success btn-next-level">Next Level</button>\n    </div>\n  </div>\n</div>\n<f>\n  <div id="start-modal" onclick="$(\'#start-modal\').modal(\'hide\')" class="modal fade">\n    <div class="card">\n      <h2 class="card-title">{{levelData.modals.start.title}}</h2>\n      <p class="card-subtitle lead">{{levelData.modals.start.subtitle}}</p>\n      <p class="card-text">{{levelData.modals.start.text}}</p>\n      <p ng-repeat="txt in levelData.modals.start.texts" class="card-text">{{txt}}</p>\n    </div>\n  </div>\n  <div id="finish-modal" onclick="$(\'#finish-modal\').modal(\'hide\')" class="modal fade">\n    <div class="card">\n      <h2 class="card-title">{{levelData.modals.finish.title}}</h2>\n      <p class="card-subtitle lead">{{levelData.modals.finish.subtitle}}</p>\n      <p class="card-text">{{levelData.modals.finish.text}}</p>\n      <div class="text-center">\n        <button ng-click="nextLevel()" class="btn btn-lg btn-success btn-next-level">Next Level</button>\n      </div>\n    </div>\n  </div>\n  <div id="hints-modal" onclick="$(\'#hints-modal\').modal(\'hide\')" class="modal fade">\n    <div class="card">\n      <h2 class="card-title">{{levelData.modals.start.title}}</h2>\n      <p class="card-subtitle lead">{{levelData.modals.start.subtitle}}</p>\n      <p class="card-text">{{levelData.modals.start.text}}</p>\n      <p ng-repeat="txt in levelData.modals.start.texts" class="card-text">{{txt}}</p>\n    </div>\n    <div ng-repeat="hint in levelData.modals.hints| limitTo:hintsCount" class="card">\n      <h2 class="card-title">{{hint.title}}</h2>\n      <p class="card-subtitle lead">{{hint.subtitle}}</p>\n      <p class="card-text">{{hint.text}}</p>\n      <p ng-repeat="txt in hint.texts" class="card-text">{{txt}}</p>\n    </div>\n  </div>\n</f>'),
$templateCache.put("/static/templates/views/index.html",'\n<div class="container">\n  <div id="index-container" class="index ng-cloak text-center col-md-6 col-md-offset-3">\n    <h1>Another Regex Game</h1><a href="#/play/1">\n      <button id="btn-start" class="btn btn-success btn-lg">Start</button></a>\n    <ul class="level-list list-group"><a href="#/play/{{$index}}" ng-repeat="level in allLevels" ng-show="$index&gt;0">\n        <li class="level-link list-group-item">{{$index}} - {{level.labels.title}}</li></a></ul>\n    <!--a.twitter-timeline(href="https://twitter.com/hashtag/regexgame", data-widget-id="728218971363749888", data-chrome="nofooter")--><a href="http://github.com/joaoricardo000/another-regex-game" target="_blank" title="Fork me on GitHub" class="github-fork-ribbon left-bottom fixed">Fork me on GitHub</a>\n  </div>\n</div>'),$templateCache.put("/static/templates/views/regex-builder.html",'\n<div ng-controller="RegexBuilderController" class="regex-builder-container">\n  <div ng-show="startingTools &amp;&amp; !iKnowRegexMode" class="tools-regex-input col-xs-12">\n    <div class="row answer-box">\n      <div class="regex-elements-view">\n        <div class="regex-elements-container">\n          <div ng-repeat="regexElement in regexElements" class="regex-element regex-element-{{regexElement.type}}">{{regexElement.value}}<span class="regex-element-quantifier">{{regexElement.quantifier}}</span></div>\n        </div>\n      </div>\n      <button ng-click="resetTools(true)" class="btn-reset btn fa fa-trash-o"></button>\n    </div>\n    <div class="row tools-box">\n      <div ng-repeat="(toolType, quantity) in availableTools" class="tool tool-{{toolType}}"><span ng-show="quantity&gt;=0">{{quantity}}x</span>\n        <button ng-click="useTool(toolType)" ng-disabled="quantity == 0" class="btn btn-info">{{toolsLabel[toolType]}}</button>\n      </div>\n    </div>\n  </div>\n  <div ng-show="iKnowRegexMode || startingTools==false" class="raw-regex-input">\n    <div class="quick-tools-view">\n      <div onclick="$(\'.raw-regex-input input\').focus()" class="btn-group quick-tools">\n        <button type="button" ng-click="addQuickTool(tool)" ng-repeat="tool in quickTools" class="btn btn-sm btn-info">{{tool}}</button>\n      </div>\n    </div>\n    <input type="text" placeholder="//" ng-model="rawRegex" ng-change="onRawRegexUpdate()" class="input-lg form-control"/>\n  </div>\n  <!-- modals-->\n  <div id="input-letter-modal" class="modal input-modal">\n    <h1 class="letter-display">{{inputValue || \'a-z\'}} {{inputQuantifier}}</h1>\n    <form ng-submit="selectToolLetter()" target="">\n      <div data-toggle="buttons" class="btn-group group-quantifier">\n        <label ng-click="inputQuantifier = \'\'" class="btn btn-warning btn-quantifier">\n          <input type="radio"/>1\n        </label>\n        <label ng-click="inputQuantifier = \'?\'" class="btn btn-warning btn-quantifier">\n          <input type="radio"/>?\n        </label>\n        <label ng-click="inputQuantifier = \'+\'" class="btn btn-warning btn-quantifier qtf-plus">\n          <input type="radio"/>+\n        </label>\n        <label ng-click="inputQuantifier = \'*\'" class="btn btn-warning btn-quantifier qtf-star">\n          <input type="radio"/>*\n        </label>\n      </div><br/>\n      <div class="input-group">\n        <input id="input-letter" type="text" placeholder="abc" autocomplete="off" ng-model="inputValue" ng-change="inputFilters[\'letter\']()" class="form-control"/><span class="input-group-btn">\n          <input type="submit" value="Ok" class="btn btn-success"/></span>\n      </div>\n    </form>\n  </div>\n  <div id="input-group-modal" class="modal input-modal">\n    <h1 class="letter-display">[{{isGroupNegated?\'^\':\'\'}}{{inputValue || \'a-z\'}}] {{inputQuantifier}}</h1>\n    <form ng-submit="selectToolGroup()" target="">\n      <div data-toggle="buttons" class="btn-group group-quantifier">\n        <label ng-click="inputQuantifier = \'\'" class="btn btn-warning btn-quantifier">\n          <input type="radio"/>1\n        </label>\n        <label ng-click="inputQuantifier = \'?\'" class="btn btn-warning btn-quantifier">\n          <input type="radio"/>?\n        </label>\n        <label ng-click="inputQuantifier = \'+\'" class="btn btn-warning btn-quantifier qtf-plus">\n          <input type="radio"/>+\n        </label>\n        <label ng-click="inputQuantifier = \'*\'" class="btn btn-warning btn-quantifier qtf-star">\n          <input type="radio"/>*\n        </label>\n      </div><br/>\n      <div class="input-group">\n        <input id="input-group" type="text" placeholder="abc" autocomplete="off" ng-model="inputValue" ng-change="inputFilters[\'group\']()" class="form-control"/><span class="input-group-btn">\n          <input type="submit" value="Ok" class="btn btn-success"/></span>\n      </div>\n    </form>\n  </div>\n</div>'),$templateCache.put("/static/templates/views/search.html",'\n<div class="container search ng-cloak">\n  <div id="search-container" class="col-md-6 col-md-offset-3">\n    <div class="title col-xs-12">\n      <h1>Search</h1>\n      <div class="load-icon"><i ng-show="wordsList==null" class="fa fa-spin fa-refresh"></i></div>\n    </div>\n    <div ng-include="\'/static/templates/views/regex-builder.html\'" onload="updateRegexBuilder()" class="regex-builder row"></div>\n    <div ng-show="matches.length" class="words-list col-xs-12">\n      <h3>{{ totalMatches }}</h3>\n      <ul class="list-group list-good-words">\n        <li ng-repeat="match in matches" ng-bind-html="match.text" class="list-group-item"></li>\n      </ul>\n    </div>\n  </div>\n</div>')}]);